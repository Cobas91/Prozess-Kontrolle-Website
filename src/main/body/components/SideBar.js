      ...
      return (
        <div className="col-lg-1 sidebar">
          ...
          <ul className={sideBarClass}>
            ...
            <li>
              {" "}
              <FiCodesandbox className="navIcon" />
              Übersicht
              <ul className="sub-menu">
                <li>
                  <Link
                    onClick={() => {
                      this.props.setSite("uebersicht", { SN: null });
                    }}
                  >
                    <FiActivity
                      onClick={() => {
            ...
            <li>
              {" "}
              <FiBox className="navIcon" />
              Systeme
              <ul className="sub-menu">
                <li>
                  <Link
                    onClick={() => {
                      this.props.setSite("masschange", { SN: null });
                    }}
                  >
                    <FiEdit
                      onClick={() => {
                        this.props.setSite("masschange", {});
                      }}
                      className="navIcon"
                    />
                    Massen Änderung
                ...
                <li>
                  <Link
                    onClick={() => {
                      this.props.setSite("editsystem", { SN: null });
                    }}
                  >
                    <FiEdit
                      onClick={() => {
                        this.props.setSite("editsystem", {});
                      }}
                      className="navIcon"
                    />
                    Edit System
